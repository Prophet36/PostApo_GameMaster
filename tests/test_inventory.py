...
class InventoryTests(unittest.TestCase):
    ...
    def test_create_inventory_with_equipped_items(self):
        armor = Armor(item_id="armor", tags="armor", name="Armor", desc="Test armor.", dmg_res=0, rad_res=10, evasion=2,
                      value=10, weight=2.5)
...
class InventoryItemAdderTests(unittest.TestCase):
    ...
    def test_add_item(self):
        item_to_add = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Pistol", desc="Test pistol.",
    ...
    def test_add_same_type_stackables_merges_stacks_into_sum_of_both_stacks(self):
        stackable_to_add = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.", max_stack=50,
                                current_amount=30, value=1, weight=0.01)
        additional_stackable_to_add = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.",
    ...
    def test_add_different_type_stackables(self):
        stackable_to_add = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.", max_stack=50,
                                current_amount=30, value=1, weight=0.01)
        additional_stackable_to_add = Ammo(item_id="other_ammo", tags="ammo, stackable", name="Other Ammo",
    ...
    def test_inventory_with_multiple_items_as_str_representation(self):
        ammo = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.", max_stack=50,
                    current_amount=30, value=1, weight=0.01)
        weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Pistol", desc="Test pistol.",
...
class InventoryItemRemoverTests(unittest.TestCase):
    ...
    def test_remove_item(self):
        weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Gun", desc="Test gun.", damage="2 + 4d6",
                              armor_pen=0, accuracy=0, ammo_type="ammo", clip_size=10, ap_cost=10, st_requirement=1,
                              value=10, weight=2.0)
        InventoryItemAdder.add_item(inv=self.inventory, item_to_add=weapon)
        self.assertEqual(1, len(self.inventory.items))
...
class InventoryItemEquipperTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Gun", desc="Test gun.",
                                   ...
                                   ap_cost=10, st_requirement=1, value=10, weight=2.0)
        self.equippable_armor = Armor(item_id="armor", tags="armor", name="Armor", desc="Test armor.", dmg_res=0,
                                      rad_res=10, evasion=2, value=10, weight=2.5)
        self.equippable_weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Gun", desc="Test gun.",
                                              damage="2 + 4d6", ammo_type="ammo", clip_size=10, armor_pen=0, accuracy=0,
                                              ap_cost=10, st_requirement=1, value=10, weight=2.0)
        self.not_equippable_item = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.",
    ...
    def test_equip_item_from_outside_current_inventory_raises_exception(self):
        item_to_equip = Armor(item_id="armor", tags="armor", name="Armor", desc="Test armor.", dmg_res=0, rad_res=10,
                              evasion=2, value=10, weight=2.5)
        with self.assertRaisesRegex(Inventory.InventoryError, "no such item in inventory"):
            InventoryItemEquipper.equip_item(inv=self.inventory, item_to_equip=item_to_equip)
...
class InventoryWeaponReloaderTests(unittest.TestCase):
    ...
    def test_reload_partially_loaded_weapon(self):
        ...
        InventoryWeaponReloader.reload_weapon(inv=self.inventory, weapon_to_reload=self.inventory.equipped_weapon)
        self.assertEqual(5, self.inventory.equipped_weapon.current_ammo)
        additional_ammo = Ammo(item_id="ammo", tags="ammo, stackable", name="Ammo", desc="Test ammo.", max_stack=50,
                               current_amount=50, value=1, weight=0.01)
    ...
    def test_reload_weapon_with_incorrect_ammo_type_raises_exception(self):
        incorrect_ammo = RangedWeapon(item_id="ammo", tags="weapon, gun, short", name="Ammo", desc="Test ammo.",
                                      damage="2 + 4d6", ammo_type="ammo", clip_size=10, armor_pen=0, accuracy=0,
                                      ap_cost=10, st_requirement=1, value=10, weight=2.0)
...
class InventoryItemMoverTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        another_armor = Armor(item_id="armor", tags="armor", name="Armor", desc="Test armor.", dmg_res=0, rad_res=10,
                              evasion=2, value=10, weight=2.5)
        another_weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Gun", desc="Test gun.",
                                      damage="2 + 4d6", ammo_type="ammo", clip_size=10, armor_pen=0, accuracy=0,
                                      ap_cost=10, st_requirement=1, value=10, weight=2.0)
        additional_weapon = RangedWeapon(item_id="gun", tags="weapon, gun, short", name="Gun", desc="Test gun.",
                                         damage="2 + 4d6", ammo_type="ammo", clip_size=10, armor_pen=0, accuracy=0,
                                         ap_cost=10, st_requirement=1, value=10, weight=2.0)
    ...
    def test_move_default_equipped_armor_raises_exception(self):
        self.assertEqual(1, len(self.inventory_to_move_to.items))
        self.assertEqual(1, len(self.inventory_to_move_from.items))
