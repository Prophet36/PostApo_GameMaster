...
class ItemFactoryTests(unittest.TestCase):
    ...
    def test_create_armor(self):
        ...
        self.assertEqual("armor", armor.tags)
    ...
    def test_create_melee_weapon(self):
        ...
        self.assertEqual("weapon, melee, sharp", weapon.tags)
    ...
    def test_create_ranged_weapon(self):
        ...
        self.assertEqual("weapon, gun, short", weapon.tags)
    ...
    def test_create_ammo(self):
        ...
        self.assertEqual("ammo, stackable", ammo.tags)
    ...
    def test_create_consumable(self):
        ...
        self.assertEqual("consumable, stackable", consumable.tags)
